...
def write_tsv(starkit_run: StarKITRun, output_prefix: str):
    ...
    header = "\t".join([
        ...
        "novelty",
        "starbase_reference_id",
        "starbase_reference_family",
        "has_myb_marker",
        "myb_at_opposite_edge",
        "has_duf3723_marker",
        "nested_in",
        "adjacent_to",
    ...
    with open(output_file, "w") as f:
        ...
        for result in starkit_run.starships:
            ...
            row = "\t".join([
                ...
                novelty,
                result.homology_reference_id or "NA",
                result.homology_reference_family or "NA",
                str(result.has_myb_marker),
                str(result.myb_at_opposite_edge),
                str(result.has_duf3723_marker),
